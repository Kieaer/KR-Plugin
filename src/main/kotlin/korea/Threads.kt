    ...
    init {
        ...
        val minute = object : TimerTask() {
            ...
            val messages = arrayOf("""
                ...
                """.trimIndent(), "한국 서버에서 나오는 플러그인의 명령어들은 [green]/help[] 으로 볼 수 있으며, 자세한 명령어는 [green]/help <명령어>[] 으로 확인할 수 있습니다.", """
                버그를 발견했다면 한국 공식 Discord 에서 제보 부탁드립니다!
                제보받지 못한 버그는 오랫동안 방치될 확률이 높습니다.
                """.trimIndent(), "이 서버는 밴을 당하면 일반적인 방법으로 유저들을 처리하지 않는답니다. 처신 잘 하시길 바랍니다.", "이 서버에서는 특정 유저를 향한 욕설 및 건설 방식의 차이로 인한 채팅 분쟁의 경우 일시 추방 또는 밴 처리를 하고 있습니다.")
